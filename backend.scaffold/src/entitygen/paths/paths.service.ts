import { Injectable, InternalServerErrorException, HttpException, HttpStatus, ServiceUnavailableException, Logger } from '@nestjs/common';
...
export class PathsService {
    ...
    getProcessProjectUrl(): string | null {
        ...
        this.logger.warn({ processProjectUrl }, fs.existsSync(processProjectUrl), 'xxx')
